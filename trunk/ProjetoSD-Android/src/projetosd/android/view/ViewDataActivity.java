...
public class ViewDataActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Cursor cursor = db.query(dbm.getTableDados(),new String[]{dbm.getTableDadosFichaId(),
		dbm.getTableDadosResultado(),
		DatabaseManager.TABLE_DADOS_CREATED_DATE,
		DatabaseManager.TABLE_DADOS_NAME}, null, null, null, null, dbm.getTableDadosFichaId()+" desc");
		...
		if(textos.isEmpty())
			textos.add("Nenhum dado foi salvo.");
